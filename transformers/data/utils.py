...
def load_documents_in_segment(filepath: str) -> List[List[str]]:
    """Loads documents from file generated by WikiExtractor.
    ...
    Returns:
        ...
        a segment which contains several actual sentences except the first one which is the title.
    """
    documents = [[]]
    with open(filepath, 'r') as f:
        for line in f:
            ...
            if line[:4] == '<doc':
                ...
                # "<document ...>". We just skip those lines
                continue
            if line[:2] == '[[':
                continue
